...
const Booking = () => {
  const meetingTypes = [
    ...
    },
    {
      ...
      duration: "60 minutes",
      description: "In-depth discussion about implementation and custom solutions"
    }
  ];
  ...
  return (
    <section id="booking" className="relative bg-gray-950">
      {/* Smooth transition from light section above */}
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-16 h-16 bg-gray-800 rounded-xl flex items-center justify-center group-hover:bg-gray-700 transition-colors duration-300 flex-shrink-0">
                    <type.icon className="w-8 h-8 text-gray-400 group-hover:text-gray-300" strokeWidth={1.5} />
                  </div>
